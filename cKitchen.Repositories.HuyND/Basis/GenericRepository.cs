...
namespace cKitchen.Repositories.HuyND.Basis
{
    public class GenericRepository<T> where T : class
    {
        protected CentralKitchenFranchiseDBContext _context;

        public GenericRepository()
        {
            _context ??= new CentralKitchenFranchiseDBContext();
        }

        public GenericRepository(CentralKitchenFranchiseDBContext context)
        {
            _context = context;
        }
